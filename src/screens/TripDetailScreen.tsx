...
export const TripDetailScreen: React.FC<TripDetailScreenProps> = ({ navigation, route }) => {
  ...
  const handleSaveBoat = useCallback(async () => {
    try {
      ...
      const hjemreiseData = cleanData({ ...sharedHjemreise, type: 'hjemreise', departureDate: boatFormHjemreise.departureDate || undefined, departureTime: boatFormHjemreise.departureTime || undefined, departureAddress: boatFormHjemreise.departureAddress.trim() ? sanitizeInput(boatFormHjemreise.departureAddress) : undefined });
  ...
  const handleSaveTaxi = useCallback(async () => {
    try {
      ...
      const hjemreiseData = cleanData({ ...sharedHjemreise, type: 'hjemreise', departureDate: taxiFormHjemreise.departureDate || undefined, departureTime: taxiFormHjemreise.departureTime || undefined, departureAddress: taxiFormHjemreise.departureAddress.trim() ? sanitizeInput(taxiFormHjemreise.departureAddress) : undefined });
  ...
  const handleSaveFerry = useCallback(async () => {
    try {
      ...
      const hjemreiseData = cleanData({ ...sharedHjemreise, type: 'hjemreise', departureDate: ferryFormHjemreise.departureDate || undefined, departureTime: ferryFormHjemreise.departureTime || undefined, departureAddress: ferryFormHjemreise.departureAddress.trim() ? sanitizeInput(ferryFormHjemreise.departureAddress) : undefined });
