...
const styles = StyleSheet.create({
  ...
  dayBtn: { paddingVertical: 10, paddingHorizontal: 14, borderRadius: 10, borderWidth: 1, minWidth: 44, alignItems: 'center' },
  dayBtnText: { fontSize: 13, fontWeight: '600' },
  weekTypeRow: { flexDirection: 'row', gap: 8 },
  weekTypeBtn: { flex: 1, paddingVertical: 10, borderRadius: 10, borderWidth: 1, alignItems: 'center' },
  weekTypeBtnText: { fontSize: 13, fontWeight: '600' },
  weekCountRow: { flexDirection: 'row', gap: 8, flexWrap: 'wrap' },
  weekCountBtn: { paddingVertical: 10, paddingHorizontal: 14, borderRadius: 10, borderWidth: 1, alignItems: 'center' },
  weekCountBtnText: { fontSize: 13, fontWeight: '600' },
  customInput: { borderWidth: 1, borderRadius: 8, padding: 8, width: 60, textAlign: 'center', fontSize: 16 },
