...
interface AppIconProps {
  name: 'calendar' | 'utensils' | 'chat' | 'compass' | 'person' | 'birthday' | 'shopping' | 'transport' | 'hotel' | 'activities' | 'destination' | 'packing' | 'links' | 'documents' | 'weather' | 'currency' | 'fly' | 'train' | 'car' | 'boat' | 'ferry' | 'taxi' | 'menu' | 'house' | 'medication' | 'vaccination' | 'allergy' | 'growth' | 'pet' | 'camera' | 'image' | 'phone' | 'email' | 'send' | 'school' | 'kindergarten' | 'file' | 'pencil' | 'microphone' | 'middag' | 'bursdag' | 'fest' | 'sport' | 'restaurant' | 'kino' | 'konsert' | 'trening' | 'hoytid' | 'barnedag' | 'hjemme' | 'spill' | 'kaffe' | 'loping' | 'sykling' | 'fjelltur' | 'fiske' | 'cheerleading' | 'racketsport' | 'tur' | 'schedule' | 'vedlikehold' | 'paintColor';
  size?: number;
  color?: string;
}
