...
interface AppIconProps {
  name: 'calendar' | 'utensils' | 'chat' | 'compass' | 'person' | 'birthday' | 'shopping' | 'transport' | 'hotel' | 'activities' | 'destination' | 'packing' | 'links' | 'documents' | 'weather' | 'currency' | 'fly' | 'train' | 'car' | 'boat' | 'ferry' | 'taxi' | 'menu' | 'house' | 'medication' | 'vaccination' | 'allergy' | 'growth' | 'pet' | 'camera' | 'image' | 'phone' | 'email' | 'send' | 'school' | 'kindergarten' | 'file' | 'pencil' | 'microphone' | 'middag' | 'bursdag' | 'fest' | 'sport' | 'restaurant' | 'kino' | 'konsert' | 'trening' | 'hoytid' | 'barnedag' | 'hjemme' | 'spill' | 'kaffe' | 'loping' | 'sykling' | 'fjelltur' | 'fiske' | 'cheerleading' | 'racketsport' | 'tur' | 'schedule' | 'vedlikehold' | 'paintColor' | 'ai' | 'instruksjon' | 'oppgaver' | 'summerCabin' | 'winterCabin' | 'apartment' | 'comingHome' | 'leavingHome';
  size?: number;
  color?: string;
}
...
export const AppIcon: React.FC<AppIconProps> = ({ name, size = 24, color = '#3b5a75' }) => {
  ...
  if (name === 'microphone') return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <g transform="rotate(-10 12 12)">
        <Rect x="7" y="1" width="10" height="14" rx="5"/>
  ...
  if (name === 'send') return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      ...
      <Path d="M22 2L15 22L11 13L2 9L22 2Z" stroke={color} strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" fill={color} fillOpacity="0.15"/>
    </Svg>
  );
  ...
  if (name === 'ai') return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <Path d="M9 17.5c1 1.5 6 1.5 6 0" strokeLinecap="round"/>
      <Line x1="12" y1="4" x2="12" y2="8"/>
