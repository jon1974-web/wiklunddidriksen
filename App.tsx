...
import { HomeSpaceScreen } from './src/screens/HomeSpaceScreen';
import { HomeDetailScreen } from './src/screens/HomeDetailScreen';
import { HomeProjectListScreen } from './src/screens/HomeProjectListScreen';
import { HomeProjectDetailScreen } from './src/screens/HomeProjectDetailScreen';
...
import { KindergartenAIScreen } from './src/screens/KindergartenAIScreen';
...
type RootStackParamList = {
  ...
  KindergartenAI: { childId: string; yearId: string; familyId: string };
  ...
  SchoolActivityDetail: { activity: import('./src/types').SchoolActivity; source?: string };
  KindergartenActivityDetail: { activity: import('./src/types').KindergartenActivity; source?: string };
  ...
  return (
    <Suspense fallback={<SuspenseFallback />}>
      <Stack.Navigator>
        ...
        <Stack.Screen
          name="HomeProjects"
          component={HomeProjectListScreen}
          options={{ headerShown: false }}
        />
        <Stack.Screen
        ...
        <Stack.Screen
          ...
          component={HomeInstructionsScreen}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="HomeMaintenance"
          component={HomeMaintenanceScreen}
          options={{ headerShown: false }}
        />
        <Stack.Screen
        ...
        <Stack.Screen
          name="KindergartenAI"
          component={KindergartenAIScreen}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="SchoolAI"
